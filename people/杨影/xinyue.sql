...
-- ----------------------------
-- Table structure for bangdan_table
-- ----------------------------
DROP TABLE IF EXISTS `bangdan_table`;
CREATE TABLE `bangdan_table` (
  `text` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of bangdan_table
-- ----------------------------
...
INSERT INTO `chuban_table` VALUES ('3', 'http://127.0.0.1:3001/chuban/3.png', '最强医仙', '醉医少');
...
INSERT INTO `chuban_table` VALUES ('6', 'http://127.0.0.1:3001/chuban/6.png', '一家杂货店', '晏南');
